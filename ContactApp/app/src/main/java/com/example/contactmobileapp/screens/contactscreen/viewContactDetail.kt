...
fun DisplayContactDetails(detail: ContactDetail){
    ...
    Row(
        ...
        CreateOutlinedIconButton("Message", R.drawable.chat_icon)
        CreateOutlinedIconButton("Call", R.drawable.call_icon)
        CreateOutlinedIconButton("Video", R.drawable.video_icon)
    }
    ...
    CreateOutlinedTextIcon("Whatsapp", R.drawable.whatsapp)
    CreateOutlinedTextIcon("Telegram", R.drawable.telegram )
